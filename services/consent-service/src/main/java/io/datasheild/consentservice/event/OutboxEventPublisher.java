package io.datasheild.consentservice.event;
...
public class OutboxEventPublisher {
    ...
    private final ConsentAuditOutboxRepository outboxRepository;
    ...
    public void publishPendingEvents() {
        List<ConsentAuditOutbox> unpublished = outboxRepository.findUnpublishedEventsBatch();

        for (ConsentAuditOutbox event : unpublished) {
            try {
                String topic = "consent-events";  // Main topic
    ...
    public void archivePublishedEvents() {
        ...
        List<ConsentAuditOutbox> oldEvents = outboxRepository.findPublishedEventsBefore(sevenDaysAgo);
